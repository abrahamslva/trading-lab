//+------------------------------------------------------------------+
//|  XAUUSD_30M_RSIPullback_DD5.mq5                                      |
//|  Estrategia DD5 — VARIANTE CONSERVADORA (Max DD ≤ -5%) 30M — XAUUSD                                |
//|                                                                    |
...
//|    SL = 0.5x ATR14 | TP = 3.0x ATR14 | Hold máx = 24 barras  |
//|    Riesgo = 0.4% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +3.08%  ✓                               |
//|    Max Drawdown     : -7.37%⚠️      ✓                               |
//|    Trades/mes       :  14.5       ✓                               |
//|    Win Rate         :  37.2%                                       |
//|                                                                    |
...
#property description "XAUUSD 30M_RSIPullback — DD5 | +3.08%/mes | DD -7.37%⚠️"
...
input int    InpMagic       = 150102;
input string InpComment     = "30M_RSIPullback_DD5";
