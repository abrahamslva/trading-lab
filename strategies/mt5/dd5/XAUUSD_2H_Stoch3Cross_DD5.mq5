//+------------------------------------------------------------------+
//|  XAUUSD_2H_Stoch3Cross_DD5.mq5                                       |
//|  Estrategia DD5 — VARIANTE CONSERVADORA (Max DD ≤ -5%) 2H — XAUUSD                                 |
//|                                                                    |
...
//|    SL = 0.2x ATR14 | TP = 3.0x ATR14 | Hold máx = 2 barras   |
//|    Riesgo = 0.3% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +2.34%  ✓                               |
//|    Max Drawdown     : -4.71%      ✓  (MEJOR DD de todos los TF)  |
//|    Trades/mes       :  12.0       ✓                               |
//|    Win Rate         :  48.8%                                       |
//|                                                                    |
//|  INSTRUCCIONES MT5:                                                |
...
#property description "XAUUSD 2H_Stoch3Cross — DD5 | +2.34%/mes | DD -4.71%"
...
input int    InpMagic       = 150104;
input string InpComment     = "2H_Stoch3Cross_DD5";
