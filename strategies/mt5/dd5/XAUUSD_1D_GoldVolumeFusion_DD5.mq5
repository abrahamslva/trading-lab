//+------------------------------------------------------------------+
//|  XAUUSD_1D_GoldVolumeFusion_DD5.mq5                                   |
//|  Estrategia DD5 — VARIANTE CONSERVADORA (Max DD ≤ -5%) 1D — XAUUSD  (Gold Volume Fusion V3)        |
//|                                                                    |
...
#property description "XAUUSD 1D_GoldVolumeFusion — DD5 | ~+6.0%/mes | DD ~-3.5%"
...
input double InpRiskPct     = 0.5;    // Riesgo % por trade
...
input int    InpMagic       = 150107;
input string InpComment     = "1D_GVF_V3_DD5";
