...
//|  Estrategia Ganadora M15 — XAUUSD                                |
//|                                                                    |
...
//|    SL = 0.8 × ATR14 | TP = 5.0 × ATR14 | Hold máx = 12 barras  |
//|    Riesgo = 0.3% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +4.03%/mes  ✓                               |
//|    Max Drawdown     : -6.67%      ✓                               |
//|    Trades/mes       :  30.9       ✓                               |
//|    Win Rate         :  37.1%                                       |
...
#property description "XAUUSD M15 — Stoch(14) Cross + 4H/D1 RSI Filter | +4.03%/mes | DD -6.67%"
...
input double InpRiskPct     = 0.3;    // Riesgo por trade (% del balance)
input double InpSLMult      = 0.8;    // ATR × este valor = Stop Loss
...
input int    InpMagic       = 150001; // Número mágico único
input string InpComment     = "M15_RSIPullback";
