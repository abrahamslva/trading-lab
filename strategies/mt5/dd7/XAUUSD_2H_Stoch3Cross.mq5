...
//|    SL = 0.5 × ATR14 | TP = 3.0 × ATR14 | Hold máx = 2 barras   |
//|    Riesgo = 0.5% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +2.02%/mes  ✓                               |
//|    Max Drawdown     : -5.77%      ✓  (MEJOR DD de todos los TF)  |
//|    Trades/mes       :  12.0       ✓                               |
//|    Win Rate         :  48.8%                                       |
//|                                                                    |
//|  INSTRUCCIONES MT5:                                                |
...
#property description "XAUUSD 2H — Stoch(3) Cross + 4H/D1 RSI Filter | +2.02%/mes | DD -5.77%"
...
input int    InpMagic       = 150004;
input string InpComment     = "2H_Stoch3Cross";
