...
//|    SL = 1.8 × ATR14 | TP1 = 2.0× | TP2 = 4.0× | TP3 = 6.5×    |
...
#property description "XAUUSD 1D — Gold Volume Fusion V3 | +11.73%/mes | WR 83.4%"
...
input int    InpMagic       = 150007;
input string InpComment     = "1D_GVF_V3";
