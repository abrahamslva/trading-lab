...
//|  Estrategia Ganadora 30M — XAUUSD                                |
//|                                                                    |
...
//|    SL = 1.0 × ATR14 | TP = 3.0 × ATR14 | Hold máx = 24 barras  |
//|    Riesgo = 0.5% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +2.48%/mes  ✓                               |
//|    Max Drawdown     : -6.78%      ✓                               |
//|    Trades/mes       :  14.5       ✓                               |
//|    Win Rate         :  37.2%                                       |
//|                                                                    |
...
#property description "XAUUSD 30M — Stoch(14) Cross + 4H/D1 RSI Filter | +2.48%/mes | DD -6.78%"
...
input int    InpMagic       = 150002;
input string InpComment     = "30M_RSIPullback";
