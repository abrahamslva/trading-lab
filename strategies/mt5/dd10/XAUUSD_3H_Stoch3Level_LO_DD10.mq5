//+------------------------------------------------------------------+
//|  XAUUSD_3H_Stoch3Level_LO_DD10.mq5                                    |
//|  Estrategia DD10 — VARIANTE AGRESIVA (Max DD ≤ -10%) 3H — XAUUSD  (SOLO LARGO)                   |
//|                                                                    |
...
//|    SL = 0.4x ATR14  (muy ajustado — crítico para DD)            |
//|    TP = 4.0x ATR14 | Hold máx = 2 barras                        |
//|    Riesgo = 1.0% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +5.04%  ✓                               |
//|    Max Drawdown     : -9.67%      ✓                               |
...
#property description "XAUUSD 3H_Stoch3Level_LO — DD10 | +5.04%/mes | DD -9.67%"
...
input double InpSLMult      = 0.4;    // MUY AJUSTADO — no modificar sin backtest
...
input int    InpMagic       = 150205;
input string InpComment     = "3H_Stoch3Level_LO_DD10";
