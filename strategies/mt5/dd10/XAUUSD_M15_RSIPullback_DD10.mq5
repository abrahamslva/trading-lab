//+------------------------------------------------------------------+
//|  XAUUSD_M15_RSIPullback_DD10.mq5                                      |
//|  Estrategia DD10 — VARIANTE AGRESIVA (Max DD ≤ -10%) M15 — XAUUSD                                |
//|                                                                    |
...
//|    SL = 1.5x ATR14 | TP = 5.0x ATR14 | Hold máx = 12 barras  |
//|    Riesgo = 0.5% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +4.09%  ✓                               |
//|    Max Drawdown     : -8.27%      ✓                               |
//|    Trades/mes       :  30.9       ✓                               |
//|    Win Rate         :  37.1%                                       |
...
#property description "XAUUSD M15_RSIPullback — DD10 | +4.09%/mes | DD -8.27%"
...
input double InpRiskPct     = 0.5;    // Riesgo por trade (% del balance)
input double InpSLMult      = 1.5;    // ATR × este valor = Stop Loss
...
input int    InpMagic       = 150201; // Número mágico único
input string InpComment     = "M15_RSIPullback_DD10";
