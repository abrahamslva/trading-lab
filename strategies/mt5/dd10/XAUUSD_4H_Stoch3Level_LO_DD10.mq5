//+------------------------------------------------------------------+
//|  XAUUSD_4H_Stoch3Level_LO_DD10.mq5                                    |
//|  Estrategia DD10 — VARIANTE AGRESIVA (Max DD ≤ -10%) 4H — XAUUSD  (SOLO LARGO)                   |
//|                                                                    |
...
//|    SL = 0.7x ATR14 | TP = 2.5x ATR14 | Hold máx = 2 barras   |
//|    Riesgo = 1.5% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +3.19%  ✓                               |
//|    Max Drawdown     : -12.88%⚠️      ✓                               |
//|    Trades/mes       :  9.2        ✓                               |
...
#property description "XAUUSD 4H_Stoch3Level_LO — DD10 | +3.19%/mes | DD -12.88%⚠️"
...
input int    InpMagic       = 150206;
input string InpComment     = "4H_Stoch3Level_LO_DD10";
