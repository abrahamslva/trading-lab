//+------------------------------------------------------------------+
//|  XAUUSD_1H_Stoch3Level_DD10.mq5                                       |
//|  Estrategia DD10 — VARIANTE AGRESIVA (Max DD ≤ -10%) 1H — XAUUSD                                 |
//|                                                                    |
...
//|    SL = 0.7x ATR14 | TP = 5.0x ATR14 | Hold máx = 2 barras   |
//|    Riesgo = 0.8% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +6.74%  ✓  (MEJOR TF INTRADAY)         |
//|    Max Drawdown     : -8.75%      ✓                               |
//|    Trades/mes       :  19.3       ✓                               |
...
#property description "XAUUSD 1H_Stoch3Level — DD10 | +6.74%/mes | DD -8.75%"
...
input int    InpMagic       = 150203;
input string InpComment     = "1H_Stoch3Level_DD10";
