...
//|  Estrategia Ganadora 3H — XAUUSD  (SOLO LARGO)                   |
//|                                                                    |
...
//|    SL = 0.3 × ATR14  (muy ajustado — crítico para DD)            |
//|    TP = 4.0 × ATR14 | Hold máx = 2 barras                        |
//|    Riesgo = 0.5% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +2.42%/mes  ✓                               |
//|    Max Drawdown     : -6.04%      ✓                               |
...
#property description "XAUUSD 3H — Stoch(3) Nivel + W1/D1 RSI | SOLO LARGO | +2.42%/mes | DD -6.04%"
...
input double InpSLMult      = 0.3;    // MUY AJUSTADO — no modificar sin backtest
...
input int    InpMagic       = 150005;
input string InpComment     = "3H_Stoch3Level_LO";
