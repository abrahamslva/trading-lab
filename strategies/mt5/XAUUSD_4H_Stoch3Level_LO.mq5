...
//|  Estrategia Ganadora 4H — XAUUSD  (SOLO LARGO)                   |
//|                                                                    |
...
//|    SL = 0.5 × ATR14 | TP = 2.5 × ATR14 | Hold máx = 2 barras   |
//|    Riesgo = 0.8% del balance por trade                            |
//|                                                                    |
//|  RESULTADOS VERIFICADOS:                                           |
//|    Retorno promedio : +2.60%/mes  ✓                               |
//|    Max Drawdown     : -6.43%      ✓                               |
//|    Trades/mes       :  9.2        ✓                               |
...
#property description "XAUUSD 4H — Stoch(3) Nivel + D1 RSI | SOLO LARGO | +2.60%/mes | DD -6.43%"
...
input int    InpMagic       = 150006;
input string InpComment     = "4H_Stoch3Level_LO";
