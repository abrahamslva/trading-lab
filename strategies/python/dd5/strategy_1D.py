...
Resultado estimado (escalado desde DD7):
  Retorno mensual : +0.56%/mes  ❌ (≥2% objetivo)
  Max Drawdown    : -13.92% (estimado)  ❌ NO pasa objetivo
  Trades/mes      : 26.2    ✅
  Win Rate        : 83.4%   (sin cambio — misma señal)

NOTA: Escalado 0.5× desde DD7 (risk_pct=0.5% vs 1.0%). No pasa objetivos.
"""
...
MONTHLY_SUMMARY = """
  ...
  ====================================================================
    ...
    Max Drawdown real    : -13.9%  (objetivo: ≤-5%)
    ...
    2019      -0.23%     -0.52%     6.0   21.1%    3    9
    2020      +1.18%     -1.10%    16.8   20.9%    3    9
    2021      -0.42%     -0.48%     3.0    6.7%    0   12
    2022      -0.04%     -0.15%     1.5   22.2%    3    9
    2023      -0.14%     -0.15%     2.0    9.3%    2   10
    2024      +1.39%     -0.23%     9.6   53.5%    7    5
    2025      +4.14%     -0.20%    23.0   58.1%    7    5
    ...
    2023-07    -0.19%   -0.19%       1   0.0%   -0.19%  ✗
    2023-08    -0.57%   -0.57%       3   0.0%   -0.19%  ✗
    2023-09    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2023-10    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2023-11    -0.19%   -0.19%       1   0.0%   -0.19%  ✗
    2023-12    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2024-01    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2024-02    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2024-03    +2.51%    0.00%      11 100.0%    0.00%  ✓
    2024-04    +8.79%    0.00%      37 100.0%    0.00%  ✓
    2024-05    -0.44%   -0.44%       4  25.0%   -0.25%  ✗
    2024-06    -0.18%   -0.18%       2   0.0%   -0.18%  ✗
    2024-07    +0.18%    0.00%       1 100.0%    0.00%  ✓
    2024-08    +0.59%   -0.19%       5  80.0%   -0.19%  ✓
    2024-09    +2.46%   -0.19%      16  87.5%   -0.20%  ✓
    2024-10    +2.54%   -0.38%      15  86.7%   -0.38%  ✓
    2024-11    +1.09%   -0.41%      19  63.2%   -0.24%  ✓
    2024-12    -0.92%   -0.92%       5   0.0%   -0.56%  ✗
    2025-01    +3.86%    0.00%      15 100.0%    0.00%  ✓
    2025-02    +7.42%    0.00%      44  88.6%    0.00%  ✓
    2025-03    +4.47%    0.00%      22 100.0%    0.00%  ✓
    2025-04    +3.85%   -0.39%      41  73.2%   -0.39%  ✓
    2025-05    -0.81%   -0.87%      10  30.0%   -0.46%  ✗
    2025-06    -0.36%   -0.36%       2   0.0%   -0.18%  ✗
    2025-07    -0.19%   -0.19%       1   0.0%   -0.19%  ✗
    2025-08    -0.18%   -0.36%       4  25.0%   -0.18%  ✗
    2025-09   +12.35%    0.00%      49 100.0%    0.00%  ✓
    2025-10   +15.70%   -0.15%      66  93.9%   -0.15%  ✓
    2025-11    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2025-12    +3.55%    0.00%      22  86.4%    0.00%  ✓
    2026-01   +18.11%    0.00%      68  97.1%    0.00%  ✓
    2026-02    +0.00%    0.00%       0   0.0%    0.00%  ✗
    2026-03    -3.85%   -3.85%      18   0.0%   -2.21%  ✗
    2026-04    -0.55%   -0.55%       3   0.0%   -0.37%  ✗
