//+------------------------------------------------------------------+
//|  EA_XAUUSD_GoldVolumeFusionElite_v1.mq5                        |
//|  GOLD VOLUME FUSION ELITE — Strategy v1.0                       |
//|                                                                  |
...
input double  CMF_Threshold     = 0.05;  // Umbral CMF alcista/bajista
...
input double  TP1_Ratio         = 2.0;  // TP1 ratio RR
input double  TP2_Ratio         = 4.0;  // TP2 ratio RR
input double  TP3_Ratio         = 6.5;  // TP3 ratio RR
...
input int     MinScoreToEnter   = 5;    // Score mínimo para entrada (max=12)
...
int OnInit()
{
   ...
   PrintFormat("EA Gold Volume Fusion Elite v1 iniciado | Symbol=%s | TF=%s | Magic=%d",
